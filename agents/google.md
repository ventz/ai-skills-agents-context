...
- **Model:** defaults to `gemini-3.1-pro-preview` via `~/.gemini/settings.json` (`model.name`). The latest Gemini Pro available in this Vertex AI project (`<your-vertex-project>`).
